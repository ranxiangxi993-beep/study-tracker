...
export async function isIgnoringBatteryOptimizations() {
  ...
  try {
    return await L.isIgnoringBatteryOptimizations();
  } catch (e) {
    return false;
  }
}
...
export async function isAccessibilityEnabled() {
  ...
  try {
    return await L.isAccessibilityEnabled();
  } catch (e) {
    return false;
  }
}
...
export async function isAccessibilitySettingOn() {
  ...
  try {
    return await L.isAccessibilitySettingOn();
  } catch (e) {
    return false;
  }
}
...
export async function openAccessibilitySettings() {
  ...
  try {
    await L.openAccessibilitySettings();
  } catch (e) {}
}
...
export async function openBatterySettings() {
  ...
  try {
    await L.openBatterySettings();
  } catch (e) {}
}

export async function lockScreen(level = "strong") {
  if (!L?.lock) return "none";
  try {
    if (L.setLockLevel) await L.setLockLevel(level);
